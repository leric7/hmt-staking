...
contract EscrowFactory {
    ...
    constructor(address _eip20, address _staking) public {
        eip20 = _eip20;
        staking = _staking;
    }
    ...
    modifier onlyLauncher(address _user) {
        require(IStaking(staking).hasStake(_user), "not staked HMT");
        _;
    }
}
